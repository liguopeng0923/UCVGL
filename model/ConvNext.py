...
def convnext_tiny(pretrained=False,down_from_url=True,model_folder="~/.cache/torch/hub/checkpoints/",weight_name='1k', **kwargs):
    model = ConvNeXt(depths=[3, 3, 9, 3], dims=[96, 192, 384, 768], **kwargs)
    if pretrained:
        assert weight_name in ['1k', '22k','22k_1k_384','22k_1k_224'], "weight_name must be either '1k' or '22k' or '22k_1k_384'"
...
def convnext_small(pretrained=True,model_folder="~/.cache/torch/hub/checkpoints/",weight_name='22k_1k_224', **kwargs):
...
def convnext_base(pretrained=True,model_folder="~/.cache/torch/hub/checkpoints/", weight_name='22k_1k_384', **kwargs):
...
def convnext_large(pretrained=False,down_from_url=True,model_folder="~/.cache/torch/hub/checkpoints/", weight_name='1k', **kwargs):
...
def convnext_xlarge(pretrained=False,down_from_url=True,model_folder="~/.cache/torch/hub/checkpoints/", weight_name='1k',**kwargs):
...
class model(nn.Module):
    ...
    def __init__(self, 
        ...
        if "convnext_base" in model_name:
            self.model = convnext_base(pretrained=pretrained,weight_name=weight_name,model_folder=model_folder,**kwargs)
        elif "convnext_small" in model_name:
            self.model = convnext_small(pretrained=pretrained,weight_name=weight_name,model_folder=model_folder,**kwargs)
